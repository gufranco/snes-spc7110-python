...
class LocalUpstream:
    ...
    def __init__(self) -> None:
        ...
        (self.where / "spc7110dec.cpp").write_text(
            "before\nuint8 SPC7110Decomp::read() { return 0; }\n#endif\n"
        )
        (self.where / "spc7110dec.h").write_text("class SPC7110Decomp {};\n")
        for step in (
    ...
    def pinned(self) -> Any:
        return {
            ...
            "sparse": ["."],
            "path": ".",
            "source": "spc7110dec.cpp",
            "header": "spc7110dec.h",
            "from": "uint8 SPC7110Decomp::read()",
            "until": "#endif",
        }
